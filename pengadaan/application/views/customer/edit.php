    ...
    <div class="col-md-8">
        <div class="card shadow-sm mb-4 border-bottom-primary">
            ...
            <div class="card-body pb-2">
                ...
                <?= form_open('', [], ['id_user' => $customer['id_customer']]); ?>
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="name">Nama</label>
                    <div class="col-md-6">
                        <input value="<?= set_value('nama'); ?>" type="text" id="name" name="name" class="form-control" placeholder="Nama">
              ...
              <div class="row form-group">
                  ...
                  <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="notlp">Nomor Telepon</label>
                    <div class="col-md-6">
                        <input value="<?= set_value('notlp'); ?>" type="text" id="notlp" name="notlp" class="form-control" placeholder="Nomor Telepon">
                        <?= form_error('notlp', '<span class="text-danger small">', '</span>'); ?>
                    </div>
                </div>
                <hr>
               ...
               <div class="row form-group">
                    ...
                    <div class="col-md-5">
                        <input readonly="readonly" id="jumlah" type="number" class="form-control">
                    </div>
                </div>

                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="tanggal_sewa">Tanggal Sewa</label>
                    <div class="col-md-4">
                        <input value="<?= set_value('tanggal_sewa', date('Y-m-d')); ?>" name="tanggal_sewa" id="tanggal_sewa" type="text" class="form-control date" placeholder="Tanggal Sewa...">
                        <?= form_error('tanggal_sewa', '<small class="text-danger">', '</small>'); ?>
                    </div>
                </div>
